...
- **Multipanel_plot_{file_name}.png**  
  Combined visualization showing all relevant plots for a given isolate (see Section 5). If the plots are batched, please consider all batches together as one complete picture to interpret the underlying methylome results
