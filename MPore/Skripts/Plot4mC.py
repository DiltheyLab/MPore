...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun 24 17:54:05 2024
    ...
    if matched_files_5mC:
        ...
        for motif, scores in motif_scores.items():
            if 'C' in motif:
                ...
                ax.set_title(f'4mC Boxplot for {motif}')
                ...
                #plt.show()
                plt.savefig(os.path.join(args.output_dir, f'{motif}_4mC_boxplot.png'))
                plt.close()
        
    else:
        print("No 4mC Files found.")       
