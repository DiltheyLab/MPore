...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun 24 17:57:00 2024
...
def main():
    ...
    #mtase_presence_path = "/Users/azlannisar/Snakemake_Test/Mtase_presence_e_25_values.csv"
    ...
    if matched_files_5mC:
        ...
        for motif, scores in motif_scores.items():
            if 'A' in motif:
                ...
                ax.set_title(f'Boxplot for {motif}')
                ...
                #plt.show()
                plt.savefig(os.path.join(args.output_dir, f'{motif}_6mA_boxplot.png'))
                plt.close()
        
    else:
        print("No 6mA Files found.")       
