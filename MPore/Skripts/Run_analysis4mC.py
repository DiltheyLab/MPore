...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun 24 19:13:30 2024
...
def parse_arguments():
    parser = argparse.ArgumentParser(description='MikrobAnalysis_4mC script')
...
def main():
    ...
    #csv_file_path = "/Users/azlannisar/Snakemake_Output_final/VRE_Data/Output2/Data_Test_updated.csv"
    ...
    for index, row in data_df.iterrows():
       ...
       # matches_reverse_all = {k: v for k, v in matches_reverse_all.items() if len(v) >= 20 and len(k) >= 3}
        ...
        #dir_path="/Users/azlannisar/Snakemake_Output_final/VRE_Data/Output2"
        ...
        xlsx_file_path2 = os.path.join(dir_path, f"Sample_DF_detailed_{list_name}_4mC")
        csv_file_path2 = os.path.join(dir_path, f"Sample_DF_detailed_{list_name}_4mC")
        
        csv_file_path3 = os.path.join(dir_path, f"Sample_DF_detailed_{list_name}_4mC.csv")
